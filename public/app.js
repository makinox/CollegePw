...
'use strict';var page=require('page'),$=require('jquery'),template=require('./template'),title=require('./../global/title'),conect=require('./../global/index'),$main=$('#main-container');page('/ges-users',function(){title('Utopia | Gestiona tus usuarios'),$main.empty().append(template),$main.find('#ges-users').on('submit',function(a){a.preventDefault();var b=$main.find('.idUsuario').val().trim();console.log(b),$('#ges-users').addClass('form-hide'),$('#dbStatus').removeClass('form-hide2'),$main.find('.relev').remove(),$.ajax({url:'http://'+conect.host+'/users/'+b,type:'GET',success:async function success(a,b,c){await a.forEach(async function(a){await $main.find('.nombresb').empty().html('Nombre: <strong>'+a.nombres+'</strong>'),await $main.find('.apellidosb').empty().html('Apellidos: <strong>'+a.apellidos+'</strong>'),await $main.find('.usuariob').empty().html('Usuario: <strong>'+a.usuario+'</strong>'),await $main.find('.contrase\xF1ab').empty().html('Contrase\xF1a: <strong>'+a.contraseña+'</strong>'),await $main.find('.emailb').empty().html('Email: <strong>'+a.email+'</strong>'),await $main.find('.rolb').empty().html('Rol: <strong>'+a.rol+'</strong>'),await $main.find('.documentob').empty().html('Documento: <strong>'+a.documento+'</strong>')}),console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}}),$main.find('.modificarId').on('click',function(a){a.preventDefault(),$('#dbForm').removeClass('form-hide'),$main.find('#dbForm').on('submit',function(a){a.preventDefault();var c=$main.find('.nombresa').val().trim(),d=$main.find('.apellidosa').val().trim(),e=$main.find('.contrase\xF1aa').val().trim(),f=$main.find('.emaila').val().trim(),g=$main.find('.rola').val(),h=$main.find('.usuarioa').val(),i=$main.find('.documentoa').val();return null==g?console.log('Seleccionar un rol valido'):void $.ajax({type:'PUT',url:'http://'+conect.host+'/users/'+b,data:{nombres:c,apellidos:d,contraseña:e,email:f,rol:g,usuario:h,documento:i},success:function success(a,b,c){console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}})})}),$main.find('borrarId').on('click',function(a){a.preventDefault(),$.ajax({type:'DELETE',url:'http://'+conect.host+'/users/'+b,success:function success(a,b,c){console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}})})})});

},{"./../global/index":11,"./../global/title":12,"./template":10,"jquery":25,"page":26}],10:[function(require,module,exports){
...
(function (process){
'use strict';var $=require('jquery'),conect={host:process.env.ip||'192.168.0.31:3001',id:'makinox',asignature:0},$container=$('#main-container'),faded=function(){$('.overlay').fadeToggle(500),$('nav').toggleClass('visible').toggleClass('invisible'),$container.toggleClass('gauss'),$('.button i').toggleClass('btn-open').toggleClass('btn-close')};$.when($container.ready(function(){$container.find('.sk-cube-grid').empty(),$('.relleno').remove(),$container.fadeIn('slow'),$('.button a').click(faded),$('.overlay a').click(faded)})),$.ajax({url:'http://'+conect.host+'/users/'+conect.id,type:'GET',success:async function success(a,b,c){await a.forEach(async function(a){await $('#header-container').find('.name').empty().html(a.nombres)}),console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}}),module.exports=conect;
...
'use strict';var page=require('page'),$=require('jquery'),template=require('./template'),title=require('./../global/title'),conect=require('../global/index');page('/profile',function(){title('Utopia | Tu perfil'),$('#main-container').empty().append(template),$.ajax({url:'http://'+conect.host+'/users/'+conect.id,type:'GET',success:async function success(a){await a.forEach(async function(a){await $('#main-container').find('.apellidos').empty().html(a.nombres+' '+a.apellidos)})}})});
...
'use strict';var page=require('page'),$=require('jquery'),template=require('./template'),title=require('./../global/title'),conect=require('./../global/index'),$main=$('#main-container');page('/signin',function(){title('Utopia | Ingresa'),$main.empty().append(template),$main.find('#signina').on('submit',function(a){a.preventDefault();var b=$main.find('.uAuth').val(),c=$main.find('.pAuth').val();console.log(b),console.log(c),$.ajax({url:'http://'+conect.host+'/auth/'+b+'&'+c,type:'GET',success:async function success(a){!0===a?(page.redirect(),console.log('Pasaste'),conect.id=b):!1===a?console.log('intentelo de nuevo'):console.log('Algo paso')}})})});

},{"./../global/index":11,"./../global/title":12,"./template":21,"jquery":25,"page":26}],21:[function(require,module,exports){

...
'use strict';var page=require('page'),$=require('jquery'),template=require('./template'),title=require('./../global/title'),conect=require('./../global/index'),$main=$('#main-container');page('/gen-users',function(){title('Utopia | Genera nuevos usuarios'),$main.empty().append(template),$main.find('#gen-users').on('submit',function(a){a.preventDefault();var b=$main.find('.nombresa').val().trim(),c=$main.find('.apellidosa').val().trim(),d=$main.find('.contrase\xF1aa').val().trim(),e=$main.find('.emaila').val().trim(),f=$main.find('.rola').val();return null==f?console.log('Seleccionar un rol valido'):void(console.log(b),console.log(c),console.log(d),console.log(e),console.log(f),$.ajax({type:'POST',url:'http://'+conect.host+'/users',data:{nombres:b,apellidos:c,contraseña:d,email:e,rol:f},success:function success(a,b,c){console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}}))})});
...
'use strict';var page=require('page'),$=require('jquery'),template=require('./template'),title=require('./../global/title'),conect=require('./../global/index'),$main=$('#main-container');page('/ges-users',function(){title('Utopia | Gestiona tus usuarios'),$main.empty().append(template),$main.find('#ges-users').on('submit',function(a){a.preventDefault();var b=$main.find('.idUsuario').val().trim();console.log(b),$('#ges-users').addClass('form-hide'),$('#dbStatus').removeClass('form-hide2'),$main.find('.relev').remove(),$.ajax({url:'http://'+conect.host+'/users/'+b,type:'GET',success:async function success(a,b,c){await a.forEach(async function(a){await $main.find('.nombresb').empty().html('Nombre: <strong>'+a.nombres+'</strong>'),await $main.find('.apellidosb').empty().html('Apellidos: <strong>'+a.apellidos+'</strong>'),await $main.find('.contrase\xF1ab').empty().html('Contrase\xF1a: <strong>'+a.contraseña+'</strong>'),await $main.find('.emailb').empty().html('Email: <strong>'+a.email+'</strong>'),await $main.find('.rolb').empty().html('Rol: <strong>'+a.rol+'</strong>'),await $main.find('.codigob').empty().html('Codigo: <strong>'+a.codigo+'</strong>')}),console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}}),$main.find('.modificarId').on('click',function(a){a.preventDefault(),$('#dbForm').removeClass('form-hide'),$main.find('#dbForm').on('submit',function(a){a.preventDefault();var c=$main.find('.nombresa').val().trim(),d=$main.find('.apellidosa').val().trim(),e=$main.find('.contrase\xF1aa').val().trim(),f=$main.find('.emaila').val().trim(),g=$main.find('.rola').val();return null==g?console.log('Seleccionar un rol valido'):void $.ajax({type:'PUT',url:'http://'+conect.host+'/users/'+b,data:{nombres:c,apellidos:d,contraseña:e,email:f,rol:g},success:function success(a,b,c){console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}})})}),$main.find('borrarId').on('click',function(a){a.preventDefault(),$.ajax({type:'DELETE',url:'http://'+conect.host+'/users/'+b,success:function success(a,b,c){console.log(a),console.log(b),console.log(c)},error:function error(a,b,c){console.log(a),console.log(b),console.log(c)}})})})});
